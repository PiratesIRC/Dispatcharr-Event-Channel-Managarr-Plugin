#!/usr/bin/env python3
"""Bump the Event-Channel-Managarr plugin version in plugin.json and plugin.py.

Version format: 1.26.{DDD}{HHMM} where DDD is day-of-year (3 digits) and
HHMM is 4-digit UTC time. Matches the convention used by Lineuparr
(e.g. `1.26.1021446` = day 102, 14:46 UTC). Pass a version string to
override the auto-generated value.

Usage:
    python3 bump_version.py              # auto, current UTC timestamp
